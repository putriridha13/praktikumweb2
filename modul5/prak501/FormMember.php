            ...
            <tr>
                ...
                <td>
                    <input type="text" name="nama"
                        <?php echo (isset($_GET['id_member'])) ?  "value = " . $data[0]["nama_member"] . "" : "value = '' "; ?>><br>
                </td>
            </tr>
            <tr>
                <td>Nomor Member</td>
                <td>
                    <input type="text" name="nomor_member"
                        <?php echo (isset($_GET['id_member'])) ?  "value = " . $data[0]["nomor_member"] . "" : "value = '' "; ?>><br>
                </td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td>
                    <textarea name="alamat" cols="30" rows="10"
                        required> <?php echo (isset($_GET['id_member'])) ?  $data[0]["alamat"]  : ""; ?> </textarea>
                    <br>
                </td>
            </tr>
            <tr>
                <td>tgl mendaftar</td>
                <td>
                    <input type="datetime-local" name="tgl_daftar"
                        <?php echo (isset($_GET['id_member'])) ?  "value = " . date('Y-m-d\TH:i', strtotime($data[0]["tgl_mendaftar"])) . "" : "value = '' "; ?>><br>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="date" name="tgl_terakhir_bayar"
                        <?php echo (isset($_GET['id_member'])) ?  "value = " . $data[0]["tgl_terakhir_bayar"] . "" : "value = '' "; ?>><br>
